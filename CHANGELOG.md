...
### Added
- Added the inert, host-neutral `pi-subagents/managed-dispatch` v1 contract foundation with strict canonical JSON, identifiers, semantic digests, and static single-host/fail-closed requirements vocabulary; no listener, provider, or managed runtime capability is registered yet.
